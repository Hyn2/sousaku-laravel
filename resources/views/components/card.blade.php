<div class="p-1 flex w-full h-[350px] bg-white border rounded-2xl shadow flex-col">
    <div class="m-3 h-3/6">
        <img alt="postImage" class="object-none object-center w-full h-full" src="https://thumbs.dreamstime.com/z/music-notes-7544001.jpg?w=576">
    </div>
    <div class="mx-3 h-3/6">
        <div class=" mx-1 flex justify-between">
            ...
            @endphp
            <p class="line-clamp-2 my-2">{{$content}}
        <div class="flex pb-1 my-0.5 border-b justify-between">
            <div class="position">{{$post->positions[0]["position"]}}</div>
